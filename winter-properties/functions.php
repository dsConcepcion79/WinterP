...
function fourty_north_ventures_scripts() {
	...
	wp_enqueue_style('fourty-north-ventures-main-styles', get_template_directory_uri() . '/css/main.css', array(), false, 'all');
	...
	wp_enqueue_script('fourty-north-ventures-main-js', get_template_directory_uri() . '/js/main.js', array('jquery'), false, true);
